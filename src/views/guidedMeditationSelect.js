    ...
    return (
      <View style={styles.container}>
        <View style={styles.body}>
          <View style={[styles.meditationContainerBig, styles.blue5]}>
            <View style={styles.meditationIconContainerBig}>
              <Image source={require('../../../src/assets/images/meditation.png')} style={{width: 40, height: 40}} />
            </View>
          </View>
        ...
        <View style={styles.iconContainer}>
          <Image source={require('../../../src/assets/images/touch.png')} style={{width: 40, height: 40}} />
        </View>
        <View style={styles.iconContainer}>
          <Image source={require('../../../src/assets/images/touch.png')} style={{width: 40, height: 40}} />
        </View>
